...
export const StreamProvider: React.FC<StreamProviderProps> = ({
  ...
  const envApiUrl: string | undefined =
    (import.meta.env.VITE_AGENT_CHAT_API_URL as string | undefined) ||
    (import.meta.env.VITE_LANGGRAPH_API_URL as string | undefined);
  const envAssistantId: string | undefined =
    import.meta.env.VITE_AGENT_CHAT_ASSISTANT_ID as string | undefined;

  // Use URL params with env var fallbacks
  const [apiUrl, setApiUrl] = useQueryState("apiUrl", {
    defaultValue: defaultApiUrl || envApiUrl || "",
  });
  const [assistantId, setAssistantId] = useQueryState("assistantId", {
    defaultValue: defaultAssistantId || envAssistantId || "",
  });
  ...
  const finalApiUrl = apiUrl || envApiUrl || defaultApiUrl;
